 ...
 */
@WebServlet("/GetCompositeUserFeed")
public class GetCompositeUserFeedServlet extends HttpServlet {
     ...
     */
    public GetCompositeUserFeedServlet() {
        super();
	...
	protected void service(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			response.getWriter().write(OBJECT_MAPPER.writeValueAsString(getCompositeUserFeed(userName, compositeFeedId)));
		}catch (Exception e) {
			log.error("Exception on CompositeFeedsListServlet", e);
		}	
	}

	public CompositeUserFeed getCompositeUserFeed(String userName, String compositeFeedId) throws Exception {
		User user = User.getXMLObjectFromXMLFileByUserName(userName);
		// title compositefeedid countOfFeeds 
		return user.getCompositeUserFeedById(compositeFeedId);
	}
