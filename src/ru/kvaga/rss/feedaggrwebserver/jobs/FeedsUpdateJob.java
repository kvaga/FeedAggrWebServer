...
//					ObjectsUtils.printXMLObject(rssFromWeb);
						...
						for (ru.kvaga.rss.feedaggr.objects.Item itemFromWeb : rssFromWeb.getChannel().getItem()) {
							...
							if (!foundItemBol) {
								...
								"<br><h3 align=\"center\" style=\"color:blue;font-size:40px;\"><a href=\""+user.getCompositeUserFeedCommonSettings().get(User.SERVER_URL_OF_WEB_APP)+"/SettingsOfSpecificUserFeedServlet?redirectTo=/SettingsOfSpecificUserFeed.jsp&command=GetSettingsOfUserFeed&feedId="+feedId+"\">FEED SETTINGS</a></h3><br>");
