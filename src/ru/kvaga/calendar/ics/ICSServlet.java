...
public class ICSServlet extends HttpServlet {
	...
	protected void service(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("Incoming parameters of getICS: " + "fileName [" + request.getParameter("ics_filename") + "], "
				+ "summary [" + request.getParameter("summary") + "]," + "description ["
				+ request.getParameter("description") + "]," + "date_format [" + request.getParameter("date_format")
				+ "], " + "date [" + request.getParameter("date") + "]," + "incoming_timezone ["
				+ request.getParameter("incoming_timezone") + "]" + "outgoing_timezone ["
				+ request.getParameter("outgoing_timezone") + "]");
		...
		try {
			response.getWriter()
					.write(getICS(request.getParameter("summary"), request.getParameter("description"),
							request.getParameter("date_format"), request.getParameter("date"),
							request.getParameter("incoming_timezone"), request.getParameter("outgoing_timezone")));
	...
	public String getICS(String summary, String description, String dateFormat, String strDate, String incomingTimezone,
			String outgoingTimezone) throws ParseException {
		long t1 = new Date().getTime();
...
//		SimpleDateFormat sdfICS = new SimpleDateFormat("yyyyMMdd'T'HHmmss'Z'");
		...
		String icsTemplate = "BEGIN:VCALENDAR\r\n" + "PRODID:-//Kvaga Event Planning System\r\n" + "VERSION:2.0\r\n"
				+ "METHOD:PUBLISH\r\n" + "BEGIN:VEVENT\r\n" +
